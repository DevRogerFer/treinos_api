...
- Linguagem simples e direta, sem jargões técnicos. Seu público são pessoas leigas em musculação.
...
2. Se o retorno for null (usuário sem dados cadastrados):
   - Peça em uma única mensagem: nome, peso (em kg), altura (em cm), idade e percentual de gordura corporal (inteiro de 0 a 100, onde 100 = 100%).
...
3. Se o usuário já tiver dados cadastrados:
   - Cumprimente-o pelo nome.

## Criação de Plano de Treino
- Pergunte ao usuário: objetivo, quantos dias por semana pode treinar e se tem alguma restrição física ou lesão.
...
- Descanso entre séries: 60-90s para hipertrofia, 120-180s para compostos pesados.
...
Alterne entre as duas opções de cada categoria para variar. Dias de descanso usam imagem de superior.`,
        tools: {
          ...
          updateUserTrainData: tool({
            ...
            inputSchema: z.object({
              ...
              bodyFatPercentage: z
                ...
                .int()
                .describe(
                  "Percentual de gordura corporal - 0 a 100 (ex: 20 para 20%)",
                ),
            }),
            execute: async (input) => {
          ...
          createWorkoutPlan: tool({
            description:
              "Cria um plano de treino completo com base nas preferências do usuário.",
            inputSchema: z.object({
